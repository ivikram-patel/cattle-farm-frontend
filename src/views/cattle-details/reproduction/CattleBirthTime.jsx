...
import CattleBirthTimeModal from './CattleBirthTimeModal';


const CattleBirthTime = () => {
    ...
    const fetchList = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.get(`api/cattle-birth-list`);
    ...
    async function deleteCattle(id) {
        ...
        if (confirmDelete) {
            ...
            try {
                const response = await axiosInstance.delete(`api/delete-cattle-birth-detail/${id}`);
...
export default CattleBirthTime;