...
import CattleInseminationTimeModal from './CattleInseminationTimeModal';


const CattleInseminationTime = () => {
    ...
    const fetchList = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.get(`api/cattle-insemination-list`);
    ...
    async function deleteCattle(id) {
        ...
        if (confirmDelete) {
            ...
            try {
                const response = await axiosInstance.delete(`api/delete-cattle-insemination-detail/${id}`);
...
export default CattleInseminationTime;